...
// TODO: break this out into a separate AlarmWebSettingModule
void AlarmModule::handleWebServerConnections()
{
...
byte AlarmModule::getNexStatus(char c, byte status)
{
...
void AlarmModule::returnHttpError(WiFiEspClient* client)
{
	client->print(F("HTTP/1.1 500 Internal Server Error\r\n\r\n"));	
}

void AlarmModule::returnHttpOk(WiFiEspClient* client)
{
	client->print(F("HTTP/1.1 200 OK\r\n\r\n"));	
}

void AlarmModule::printPage(WiFiEspClient* client)
{
